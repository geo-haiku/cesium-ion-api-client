...
class CityGML(AssetOptions):
    geometry_compression: GeometryCompression = Field(
        default=GeometryCompression.DRACO, alias="geometryCompression"
    )
...
class ThreeDCapture(AssetOptions):
    ...
    texture_format: TextureFormat = Field(
        default=TextureFormat.AUTO, alias="textureFormat"
    )
